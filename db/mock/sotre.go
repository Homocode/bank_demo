...
// Source: github.com/homocode/bank_demo/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAmountToAccountBalance(arg0 context.Context, arg1 db.AddAmountToAccountBalanceParams) (db.Accounts, error) {
	m.ctrl.T.Helper()
